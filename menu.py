...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_selection = input(print(f"Enter the menu item number: "))
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items.keys():
                    ...
                    quantity = input(f"How much quantity of {menu_selection_name} do you want? If the selection is invalid, it will default to 1. ")
...
for item_list in order_list:
    ...
    num_item_spaces1 = 24 - len(item_name)
    ...
    print(f"{item_name}{item_spaces1}  | ${item_price}  | {item_quantity} ")

# 11. Calculate the cost of the order using list comprehension
# Multiply the price by quantity for each item in the order list, then sum()
# and print the prices.

total_price = sum(item_list["Price"] * item_list["Quantity"] for item_list in order_list)
